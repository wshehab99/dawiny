...
import 'bookDoctorHomeVisit.dart';

class DiagnosesListDoctorHome extends StatelessWidget {
  const DiagnosesListDoctorHome({Key? key, this.vidoecall}) : super(key: key);
